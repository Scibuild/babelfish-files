...
echo "🎧 $song_status $media_artist - $media_song | $network_active $interface_easyname | 🏋 $loadavg_5min | $audio_active $audio_volume% | $battery_pluggedin $battery_charge | $date_and_week 🕘 $current_time"
